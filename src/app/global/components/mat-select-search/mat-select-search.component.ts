...
implements OnInit, OnDestroy, ControlValueAccessor {
  // @Input() clearPreviousSelection:boolean;

  // @Output() clearPreviousSelectionEvent= new EventEmitter();
  ...
  ngOnInit() {
    ...
    if (this.matSelect.panelClass) {
      if (Array.isArray(this.matSelect.panelClass)) {
        ...
        (this.matSelect.panelClass as { [key: string]: any })[panelClass] =
          true;
      }
    } else {
